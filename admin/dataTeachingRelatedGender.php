<?php
    ...
    personal_info.emp_no=employment_record.emp_no WHERE personal_info.sex !='' AND employment_record.position_type = 'Teaching_Related' GROUP BY personal_info.sex DESC");
    $data = array();
