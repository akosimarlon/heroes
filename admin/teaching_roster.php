        ...
        <div class="modal fade" id="notifModal" aria-labelledby="notifModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="notifModalLabel">Remarks</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1"><i class="fa fa-commenting-o"></i></span>
                                    ...
                                    if(mysqli_num_rows($query_run) > 0){
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <input type="hidden" id="emp_name<?=$row['id']?>" value="<?=strtoupper($row['firstname']." ".$row['middlename']=='N/A' ? '': strtoupper(utf8_decode($user['middlename']))." ".$row['lastname'])?>">   
                                                <td><?= $count++ ?></td>                                    
                                                <td><?= $row1['emp_no'] ?></td>
