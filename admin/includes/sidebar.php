...
?>
    <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <div class="sidebar-card">
            ...
            <p class="text-left mb-2">Logged in as: </br><strong><?=$_SESSION['user_role']?></strong><span class="blink">  <i class="fa fa-circle"></i>
</span></p>
            ...
            <div id="collapsePersonnel" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <h6 class="collapse-header">CUSTOMIZE DETAILS:</h6>
                        ...
                        <a class="collapse-item" href="downloads.php?emp_no=<?=$_SESSION['auth_user']['user_empno']?>">Downloads</a>                         
                </div>
            </div>
