...
$(document).ready(function() {
  fetchchartdata4();
  setInterval(fetchchartdata4 , 10000);  
});
...
/* #### Bar Chart Example ##### */
function fetchchartdata4() { 

$.ajax({      
  url: 'dataTeachingRelatedPosition.php',
  type: 'POST',
  dataType: 'JSON',
  success: function (data) {
    ...
    for(var count=0; count<data.length; count++){
      ...
      data_array4.push(data[count].vals);
    }
    
    data_array4.max = function() { return  Math.max.apply(Math, this); };
    ...
    var myBarChart3 = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          borderColor: "#ffff00",          
          data: data_array4, //[12, 17, 4, 2, 1, 4, 0],
        }],
      },
      options: {
