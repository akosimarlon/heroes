            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <div class="d-sm-flex align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Non-Teaching Personnel</h6>
                        <div class="row">
                            <div class="col">                                
                                ...
                                <?php    
                                    $users = "SELECT COUNT(id) AS total FROM employment_record WHERE position_type='Non_Teaching' AND status='2'";
                                    $users_run = mysqli_query($con,$users);                                                
                                    if(mysqli_num_rows($users_run) > 0 ){
                                        foreach($users_run as $user){
                                            echo $user['total'];
                                ...
                                <?php    
                                    $users = "SELECT COUNT(id) AS total FROM employment_record WHERE position_type='Non_Teaching' AND status='0'";
                                    $users_run = mysqli_query($con,$users);                                                
                                    if(mysqli_num_rows($users_run) > 0 ){
                                        foreach($users_run as $user){
                                            echo $user['total'];
                                        ...
                                        ?>
                                            <tr>   
                                                ...
                                                <?php
                                                    ...
                                                    if($row1['designation']=="District") echo $row1['district']; 
                                                    if($row1['designation']=="Division") echo $row1['office_name'];
                                                ?>
                                                </td>
            ...
            <div class="col-xl-8 col-lg-7">
                <div class="card shadow mb-4">
                    ...
                    <div
                        ...
                        <h6 class="m-0 font-weight-bold text-primary">Non Teaching Personnel by Position</h6>
