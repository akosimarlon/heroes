...
<style>
    ...
    <div class="container-fluid bg-gradient-light">
        ...
        <div class="d-sm-flex align-items-center justify-content-center mb-0">
            <h3 class="h3 mb-0 text-gray-800"><b><?=strtoupper($user['firstname']);?> <?=$user['middlename']=='N/A' ? '': strtoupper($user['middlename']) ?> <?=strtoupper($user['lastname']);?><?=$user['exname']=='N/A' ? '': ', '.strtoupper($user['exname']) ?></b></h3>
        </div>
        <div class="d-sm-flex align-items-center justify-content-center mb-0">                                     
                                            ...
                                            <?php
                                                    ...
                                                    if(mysqli_num_rows($na_run) > 0 ){
                                                        foreach($na_run as $row){
                                                            if($row['n_a']=="1"){
                                                            ?>
                                                                <button type="button" class="btn btn-info addCivil  d-none d-sm-inline-block" data-bs-toggle="modal" data-bs-target="#addWorkModal" DISABLED><i class="fa fa-plus"></i> Add Work Experience</button>
                                                            <?php
                                                            }else{
                                                            ?>
                                                                <button type="button" class="btn btn-info addCivil  d-none d-sm-inline-block" data-bs-toggle="modal" data-bs-target="#addWorkModal"><i class="fa fa-plus"></i> Add Work Experience</button>
                                                            <?php
                                                            }
                                                        }
                                                    }else{
                                            ...
                                            <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td><button type="button" name="btn_child_edit" class="btn btn-success btn-sm editlearningdevbtn" <?=$row['n_a']=='1' ? 'disabled':'' ?> value="<?=$row['id']?>"><i class="far fa-edit"> Edit</i></button> 
                                                                <button type="button" name="btn_child_delete" value="<?=$row['id']?>" class="btn btn-danger btn-sm deleteLearning" data-toggle="modal" data-target="#confirmModal"><i class="fa fa-trash"> Delete</i></button> 

                                                                <button type="button" name="btn_view_cert" <?=$row['n_a']=='1' ? 'disabled':'' ?> value="<?=$row['id']?>" class="btn btn-info btn-sm viewCerti" data-toggle="modal" data-target="#viewCertModal"><i class="fa fa-eye"> View</i></button>
                                                                </td>
                                                            </tr>
                                                        <?php
                                                        }
                            ...
                            <div class="design-process-content shadow bg-white rounded border-left-info">
                                ...
                                <h3 class="semi-bold text-primary mb-5">Employment Information
                                    <div class="col-auto d-sm-inline-block">
                                        <?php
                                            if($emp_rec['status']=='1'){
                                                echo '<h6><span class="badge bg-primary" data-bs-toggle="tooltip" data-bs-placement="top"
                                                data-bs-custom-class="custom-tooltip"
                                                data-bs-title="This top tooltip is themed via CSS variables.">HR Admin Approved</span></h6>';
                                            }
                                            elseif($emp_rec['status']=='2'){
                                                echo '<h6><span class="badge bg-warning text-light" data-bs-toggle="tooltip" data-bs-placement="top"
                                                data-bs-custom-class="custom-tooltip"
                                                data-bs-title="This top tooltip is themed via CSS variables.">Pending HR Admin Approval</span></h6>';
                                            }
                                            elseif($emp_rec['status']=='0'){
                                                echo '<h6><span class="badge bg-danger text-light" data-bs-toggle="tooltip" data-bs-placement="top"
                                                data-bs-custom-class="custom-tooltip"
