...
<style>
    ...
    <div class="container-fluid bg-gradient-light">
        ...
        <div class="d-sm-flex align-items-center justify-content-center mb-0">
            <h3 class="h3 mb-0 text-gray-800"><b><?=strtoupper(utf8_decode($user['firstname']));?> <?=$user['middlename']=='N/A' ? '': strtoupper(utf8_decode($user['middlename'])) ?> <?=strtoupper(utf8_decode($user['lastname']));?><?=$user['exname']=='N/A' ? '': ', '.strtoupper($user['exname']) ?></b></h3>
        </div>
        <div class="d-sm-flex align-items-center justify-content-center mb-0">                                     
                            ...
                            <div class="design-process-content shadow bg-white text-dark rounded border-left-info">
                                ...
                                if(isset($_GET['emp_no'])){
                                    ...
                                    ?>
                                        ...
                                        <input type="hidden" name="old_fname" value="<?=$user['firstname'];?>">
                                        <input type="hidden" name="old_lname" value="<?=$user['lastname'];?>">
                                        
                                                            
                                            <div class="row mb-3">
                                                <label for="" class="col-sm-2 col-form-label ml-3">Last Name:</label>
                                                <div class="col-sm-3">
                                                    <input type="text" name="lname" value="<?=$user['lastname'];?>" class="form-control border-success" autocomplete="off" require autofocus>                                                
                                                </div>                                            
