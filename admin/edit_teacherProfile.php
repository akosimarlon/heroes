...
<style>
    ...
    <div class="container-fluid bg-gradient-light">
        ...
        <div class="d-sm-flex align-items-center justify-content-center mb-0">
            <h3 class="h3 mb-0 text-gray-800"><b><?=strtoupper($user['firstname']);?> <?=$user['middlename']=='N/A' ? '': strtoupper($user['middlename']) ?> <?=strtoupper($user['lastname']);?> <?=$user['xname']=='N/A' ? '': ', '.strtoupper($user['xname']) ?></b></h3>
        </div>
        <div class="d-sm-flex align-items-center justify-content-center mb-0">                                     
