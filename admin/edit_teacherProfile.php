...
<style>
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-center mb-0">
            <h3 class="h3 mb-0 text-gray-800"><b><?=strtoupper($user['firstname']);?> <?=strtoupper($user['middlename']);?> <?=strtoupper($user['lastname']);?></b></h3>
        </div>
        <div class="d-sm-flex align-items-center justify-content-center mb-0">                                     
                    ...
                    <form action="code.php" method="POST">
                        <div class="modal-body">
                            ...
                            <div class="form-group">                                
                                ...
                                <div class="input-group mb-3">
                                    <span class="input-group-text">P</span>
                                    <input type="text" id="Esalary" name="salary" class="form-control border-success" autocomplete="off" style="width:150px;" required autofocus>
                                </div>
                            </div>
                            <div class="form-group">                                
                                <label>SALARY / JOB / PAY GRADE (if applicable) & STEP </br>(Format "00-0") / INCREMENT</label>
                ...
                <div class="col-xs-12"> 
                    ...
                    <div class="tab-content mb-5">
                        ...
                        <div role="tabpanel" class="tab-pane" id="other">
                            <div class="design-process-content shadow bg-white rounded border-left-info">
                                <a name="#other1"></a>
                                <h3 class="semi-bold text-primary">Other Information</h3>
