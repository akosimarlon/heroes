    ...
    <div class="container-fluid">
            ...
            <div class="row align-items-start mt-2">                
                ...
                <div class="col">
                    <div class="card shadow mt-5">
                        <div class="card-header bg-gradient-primary text-gray-900">
                            <h4 class="h5 mb-0 text-white">Personal Profile</h4>
                        </div>
                        <div class="card-body">
                            
                            <div class="tab">
                                <button class="tablinks btn btn-outline-primary" onclick="openCity(event, 'personal')" id="defaultOpen">Personal Information</button>
                                <button class="tablinks btn btn-outline-primary" onclick="openCity(event, 'family')">Family Background</button>
                                <button class="tablinks btn btn-outline-primary" onclick="openCity(event, 'education')">Educational Background</button>
                                <button class="tablinks btn btn-outline-primary" onclick="openCity(event, 'civil')">Civil Service Eligibility</button>
                                <button class="tablinks btn btn-outline-primary" onclick="openCity(event, 'work')">Work Experience</button>
                                <button class="tablinks btn btn-outline-primary" onclick="openCity(event, 'voluntary')">Voluntary Work</button>
                                <button class="tablinks btn btn-outline-primary" onclick="openCity(event, 'tranings')">Training Programs Attended</button>
                                <button class="tablinks btn btn-outline-primary" onclick="openCity(event, 'more')">More Details</button>
                            </div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                <h5 class="data-label"><?=$row['mother_lastname']?>, <?=$row['mother_firstname']?> <?=$row['mother_middlename']?> </h5>
                                                <label class="info-label">Mother's Maiden Name</label>    
                                            </div>                                            
                                        </div>
                                    <?php 
                                            }
        ...
        <div class="card shadow mt-3">
            <div class="card-header py-3 bg-gradient-primary">
                <h4 class="h5 mb-0 text-white">Employment Information</h4>
            </div>
            <div class="card-body">
                <div class="tab">
